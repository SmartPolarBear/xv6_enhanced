...
typedef uint16 pci_vendor_id;
typedef uint16 pci_product_id;
...
typedef uint8 pci_class;
typedef uint8 pci_subclass;
typedef uint8 pci_interface;
typedef uint8 pci_revision;
...
typedef uint8 pci_intr_latency;
typedef uint8 pci_intr_grant;
typedef uint8 pci_intr_pin;
typedef uint8 pci_intr_line;
