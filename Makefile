...
# TODO: support multi-core in other ways
QEMUSMPOPTS= -smp cpus=$(CPUS),cores=1,threads=1,sockets=$(CPUS)
...
# port fowarding
# sysctl -w net.ipv4.ping_group_range='0 2147483647' to enable ping
